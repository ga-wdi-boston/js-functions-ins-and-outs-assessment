...
const newArray = function newArray (/*len, defaultVal*/) {

const resultArray = map(newArray, (newArray.length, 0))
...
const result = new Array(array.length) // creates an un-dynamic set/array
