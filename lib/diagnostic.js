...
const addMethod = function addMethod(propertyName, method, object) {
...
//I think this should be using constructors and .push to add to the array, I'm unsure how to start this
// Used by testing
module.exports = {
  min: min,
  sum: sum,
