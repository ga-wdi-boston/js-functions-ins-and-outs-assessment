...
describe('array creation', () => {
  ...
  describe('with default value function', () => {
    it('returns the correct array', () => {
      const length = 3
      const defaultsFunction = function defaultsFunction (index) {
        return length - index
      }
...
describe('method addition', () => {
  describe('with existing object', () => {
    const obj = {}
    const propertyName = 'method'
    const method = function () {}

    const returnedObj = diagnostic.addMethod(propertyName, method, obj)
  ...
  describe('without existing object', () => {
    ...
    const returnedObj = diagnostic.addMethod(propertyName, method)
